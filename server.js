...
function getPack(sessionOrId) {
  ...
  return truthPacks[id] || truthPacks['heresay-homicide-rookie'] || truthPacks['heresay-homicide'] || truthPacks.demo;
}
...
function createSession({ tableName = 'Table 1', truthPackId = 'heresay-homicide-rookie', playerCap = 25 } = {}) {
  let code = makeCode();
  ...
  const session = {
    ...
    code,
    tableName,
    truthPackId: truthPacks[truthPackId] ? truthPackId : 'heresay-homicide-rookie',
